...
var TASKS = [
  ...
  },
  {
    ...
    options: {
      '--no-hook|-n': 'Do not add default Ionic hooks for Cordova',
      '--no-resources|-r': 'Do not add default Ionic icons and splash screen resources'
    },
  ...
  },
  {
   ...
   },
   {
    title: 'state',
    name: 'state',
    summary: 'Saves or restores state of your Ionic Application',
    args: {
      '<COMMAND>': '[save|restore] - Saves or restores your Ionic applications state of platforms and plugins via the package.json file',
    },
    module: './ionic/state'
   },
   {
    ...
    args: {
      '<TOPIC>': 'the topic to view help documentation for'
    },
    module: './ionic/docs'
   }
];
