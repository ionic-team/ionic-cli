...
var TASKS_ES = [
  {
    ...
    args: {
      '[opciones]': 'algunos parámetros para la consola',
      '<PATH>': 'directorio para el nuevo proyecto',
      '[plantilla]': 'Nombre de la plantilla, ejemplo: tabs, sidemenu, blank\n' +
    ...
    options: {
      ...
      '--no-cordova|-w': 'Crear la estructura básica sin los requisitos de Cordova',
      '--sass|-s': 'Configurar el proyecto para usar el preprocesador Sass',
      '--list|-l': 'Listado de plantillas disponibles'
    },
    module: './ionic/start'
  },
  {
    ...
    options: {
      '--consolelogs|-c': 'Imprimir por consola los mensajes de la aplicación',
      '--serverlogs|-s': 'Imprimir por consola los mensajes del servidor',
      '--port|-p': 'Puerto HTTP del servidor (por defecto el 8100)',
      '--livereload-port|-r': 'Puerto del live reload (35729 default)',
      '--nobrowser|-b': 'Desactivar ejecutar el navegador',
      '--nolivereload|-d': 'No iniciar live reload',
      '--noproxy|-x': 'No añadir proxies',
      ...
      '--lab|-l': 'Testear la aplicacion en múltiples tamaños de pantalla y diferentes plataformas'
    },
    module: './ionic/serve'
  },
  {
    ...
    options: {
      '--noresources|-r': 'No añadir iconos y splash screen por defecto de Ionic',
      '--nosave|-e': 'No guardar la plataforma en el dichero package.json'
    },
    module: './ionic/cordova'
  },
  {
    ...
    options: {
      ...
      '--livereload-port|-r': 'Puerto del live reload ( por defecto 35729, livereload req.)',
      '--consolelogs|-c': 'Imprimir por consola los mensajes de la aplicación (livereload req.)',
      '--serverlogs|-s': 'Imprimir por consola los mensaje del servidor (livereload req.)',
      '--debug|--release': '',
      '--device|--emulator|--target=FOO': ''
    },
    module: './ionic/cordova'
  },
  {
    title: 'emulate',
    name: 'emulate',
    summary: 'Simula una aplicación en un emulador',
    args: {
      '[opciones]': '',
      '<PLATAFORMA>': ''
    },
    options: {
      ...
      '--port|-p': 'Puerto HTTP de lservidor (por defecto 8100, livereload req.)',
      '--livereload-port|-r': 'Live Reload port (por defecto 35729, livereload req.)',
      '--consolelogs|-c': 'Imprimir por consola los mensajes de la aplicación (livereload req.)',
      '--serverlogs|-s': 'Imprimir por consola los mensaje del servidor (livereload req.)',
      '--nohooks|-n': 'No añadir los hooks por defecto de Cordova',
      '--debug|--release': '',
      '--device|--emulator|--target=FOO': ''
    },
    module: './ionic/cordova'
  },
  {
    title: 'build',
    name: 'build',
    summary: 'Construir un proyecto ionic para una plataforma específica',
    args: {
      '[opciones]': '',
      '<PLATAFORMA>': ''
    },
  ...
  },
  {
    ...
    options: {
      ...
      '--nosave|-e': 'No guardar el plugin en el fichero package.json'
    },
    module: './ionic/cordova'
  },
  {
  ...
  },
  {
    ...
    name: 'package',
    alt: ['pack'],
    summary: 'Empaquetar una aplicación' + ' (beta)'.yellow,
    args: {
      '[opciones]': '',
    ...
    options: {
      '--android-keystore-file|-k': 'Fichero keystore de Android',
      '--android-keystore-alias|-a': 'Alias del keystore de Android',
      '--android-keystore-password|-w': 'Clave del keystore de Android',
      '--android-key-password|-r': 'Clave Android',
      '--ios-certificate-file|-c': 'Certificado de iOS',
      '--ios-certificate-password|-d': 'Clave del certificado de iOS',
      '--ios-profile-file|-f': 'Perfil de iOS',
      '--output|-o': 'Ruta de guardado del paquete generado',
      '--no-email|-n': 'No enviar por correo el paquete construido',
      '--clear-signing|-l': 'Limpiar todos los datos del firmado',
