...
var IonicStartTask = require('./ionic/start.js').IonicStartTask,
    IonicPlatformTask = require('./ionic/platform.js').IonicPlatformTask;
    IonicRunTask = require('./ionic/run.js').IonicRunTask;
    ...
    IonicPackageTask = require('./ionic/package.js').IonicPackageTask;
