...
var IonicStartTask = require('./ionic/start').IonicStartTask,
    ...
    IonicVersionsTask = require('./ionic/versions').IonicVersionsTask,
...
var TASKS = [
  ...
  },
  {
    title: 'deploy',
    name: 'deploy',
    summary: 'Deploy a new version of your app',
    args: {
      '<UUID>': 'The UUID of the version to deploy'
    },
    options: {
      '--note|-n': 'An optional note for this version',
      '--uuid|-u': 'The UUID of the version to deploy'
    },
  ...
  },
  {
    title: 'versions',
    name: 'versions',
    summary: 'List the versions of your app',
    task: IonicVersionsTask
  }
];
