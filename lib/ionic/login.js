...
IonicLoginTask.prototype.get = function(ionic, callback) {
  ...
  if(!this.email && this.password) {
    ionic.fail('--email or -e command line flag, or IONIC_EMAIL environment variable required');
  }
  if(this.email && !this.password) {
    ionic.fail('--password or -p command line flag, or IONIC_PASSWORD environment variable required');
  }
