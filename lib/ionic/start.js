...
IonicTask.prototype.run = function(ionic) {
  ...
  if( fs.existsSync(this.targetPath) ) {
    ...
    prompt.get({properties: promptProperties}, function (err, promptResult) {
      ...
      if(areYouSure == 'yes' || areYouSure == 'y') {
        ...
        var options = {
          ...
          isCordovaProject: self.isCordovaProject,
          setupSass: (argv.sass || this.appSetup.sass)
        }
    ...
    // console.log('Making options for start app from lib')
    ...
    // console.log('Starting app from lib')
