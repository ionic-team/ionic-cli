...
IonicTask.prototype.fetchPlnkr = function fetchPlnkr() {
  ...
  console.log('self.targetPath', self.targetPath);

  Ionic.fetchArchive(self.targetPath, plnkrUrl)
  .then(function() {
    // console.log('Done downloading')
    try {
      // Move the content of this repo into the www folder
      var copyDir = [self.targetPath + '/' + plnkrId].join('');
      console.log('copy dir', copyDir);
