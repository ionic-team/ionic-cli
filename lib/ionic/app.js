...
var IonicAppTask = function() {};

IonicAppTask.prototype = new IonicTask();

IonicAppTask.prototype.run = function(ionic) {
  var self = this;
...
IonicAppTask.prototype.versions = function(self) {
...
IonicAppTask.prototype.deploy = function(self) {
  var project = IonicProject.load();
...
IonicAppTask.prototype.getCmdLineOptions = function() {
  var self = this;
...
exports.IonicAppTask = IonicAppTask;
