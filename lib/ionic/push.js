...
PushTask.prototype.run = function(ionic, argv) {
  var self = this;
  self.ionic = ionic;
  self.inputValues = {};
  self.inputFiles = {};
...
PushTask.prototype.set_webhook_url = function(task, webhook_url) { // eslint-disable-line camelcase
...
PushTask.prototype.set_google_api_key = function(task, google_api_key) { // eslint-disable-line camelcase
  var project = IonicProject.load();
...
PushTask.prototype.send_push = function(task) { // eslint-disable-line camelcase
  var project = IonicProject.load();
...
PushTask.prototype.set_production_mode = function(task) { // eslint-disable-line camelcase
  var project = IonicProject.load();
...
PushTask.prototype.upload_cert = function(task) { // eslint-disable-line camelcase
  var project = IonicProject.load();
...
PushTask.prototype.getCmdLineOptions = function() {
  var self = this;
...
PushTask.prototype.getCsrfToken = function(jar) {
