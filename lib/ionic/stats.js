...
var path = require('path'),
    ...
    fs = require('fs'),
    os = require('os'),
    IonicConfig = require('ionic-app-lib').config,
    IonicInfo = require('ionic-app-lib').info;
...
exports.IonicStats = {
  t: function(additionalData) {
    try {
      ...
      var argsWhitelist = 'add remove list update check debug release search --livereload --consolelogs --serverlogs --no-cordova --nobrowser --nolivereload --noproxy --no-email --debug --release --device --emulator --sass --splash --icon --v2 --ts'.split(' ');
