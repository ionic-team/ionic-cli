...
exports.IonicStats = {
  t: function(additionalData) {
    try {
      ...
      var argsWhitelist = 'add remove list update check debug release search --no-cordova --nobrowser --nolivereload --no-email --debug --release --device --emulator --sass'.split(' ');
      ...
      IonicStats.mp(cmdName, statsData);
