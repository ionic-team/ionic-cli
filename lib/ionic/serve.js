...
IonicTask.prototype.OLDListentoServerCommands = function OLDListentoServerCommands() {
  var self = this;
  console.log('listenForServerCommands - stdin')
...
IonicTask.prototype.start = function(ionic) {
  try {
    ...
    app.use(server);
    try {
      console.log('Listening here: ', this.address)
