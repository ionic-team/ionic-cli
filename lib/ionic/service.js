...
ServiceTask.readIonicProjectJson = function readIonicProjectJson() {
...
ServiceTask.addServiceToIonicJson = function addServiceToIonicJson(serviceName) {
  var ionicProjectFile = path.join(process.cwd(), 'ionic.project');
...
ServiceTask.installBowerComponent = function installBowerComponent(serviceName) {
...
ServiceTask.uninstallBowerComponent = function uninstallBowerComponent(serviceName) {
...
ServiceTask.getBowerComponentsLocation = function getBowerComponentsLocation() {
...
ServiceTask.getBowerJson = function getBowerJson(directory, serviceName) {
...
ServiceTask.installBowerPlugins = function installBowerPlugins(directory, serviceName) {
...
ServiceTask.uninstallBowerPlugins = function uninstallBowerPlugins(bowerJson) {
...
ServiceTask.addService = function addService(serviceName) {
...
ServiceTask.removeService = function removeService(serviceName) {
  var directory = this.getBowerComponentsLocation();
  var packageBowerJson = this.getBowerJson(directory, serviceName);
...
ServiceTask.listServices = function listServices() {
};
...
ServiceTask.run = function run(ionic, argv) {
  this.ionic = ionic;
