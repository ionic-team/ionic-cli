...
ServiceTask.prototype.readIonicProjectJson = function readIonicProjectJson() {
...
ServiceTask.prototype.addServiceToIonicJson = function addServiceToIonicJson(serviceName) {
  var ionicProjectFile = path.join(process.cwd(), 'ionic.project');
...
ServiceTask.prototype.installBowerComponent = function installBowerComponent(serviceName) {
...
ServiceTask.prototype.uninstallBowerComponent = function uninstallBowerComponent(serviceName) {
...
ServiceTask.prototype.getBowerComponentsLocation = function getBowerComponentsLocation() {
...
ServiceTask.prototype.getBowerJson = function getBowerJson(directory, serviceName) {
...
ServiceTask.prototype.installBowerPlugins = function installBowerPlugins(directory, serviceName) {
...
ServiceTask.prototype.uninstallBowerPlugins = function uninstallBowerPlugins(bowerJson) {
...
ServiceTask.prototype.addService = function addService(serviceName) {
...
ServiceTask.prototype.removeService = function removeService(serviceName) {
  var directory = this.getBowerComponentsLocation();
  var packageBowerJson = this.getBowerJson(directory, serviceName);
...
ServiceTask.prototype.listServices = function listServices() {
};
...
ServiceTask.prototype.run = function run(ionic, argv) {
  this.ionic = ionic;
