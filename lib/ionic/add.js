...
AddTask.prototype.installBowerComponent = function installBowerComponent(componentName) {
...
AddTask.prototype.uninstallBowerComponent = function uninstallBowerComponent(componentName) {
...
AddTask.prototype.listComponents = function listComponents() {
  try {
...
AddTask.prototype.run = function(ionic, argv) {
  this.ionic = ionic;
