...
LibTask.loadVersionData = function() {
...
LibTask.printLibVersions = function() {
  var self = this;
...
LibTask.getVersionData = function(version) {
  var q = Q.defer();
  var self = this;
...
LibTask.updateLibVersion = function() {
  var self = this;
...
LibTask.downloadZip = function(version) {
  var self = this;
...
LibTask.writeVersionData = function() {
  try {
    var versionData = {
