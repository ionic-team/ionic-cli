...
IonicTask.prototype.printLibVersions = function() {
  ...
  this.getVersionData('latest').then(function(){
    log.info('Latest Ionic version: '.bold.green + self.versionData.version_number + '  (released ' + self.versionData.release_date + ')');
...
IonicTask.prototype.updateLibVersion = function() {
  ...
  log.info('Are you sure you want to replace '.green.bold + libPath.bold + ' with an updated version of Ionic?'.green.bold);
...
IonicTask.prototype.getLatest = function() {
  ...
  this.getVersionData(version).then(function(){
    if(version == 'latest') {
      log.info('Latest version: '.bold.green + self.versionData.version_number + '  (released ' + self.versionData.release_date + ')');
    } else {
      log.info('Version: '.bold.green + self.versionData.version_number + '  (released ' + self.versionData.release_date + ')');
    }
