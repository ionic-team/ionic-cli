...
IonicTask.prototype.addBrowser = function() {
  ...
  .then(function(data) {
    ...
    console.log('\nIonic Browser Add completed');
  })
  .catch(function(error){
    console.log('An error with adding a browser occured')
    console.log(error)
  })
}

IonicTask.prototype.removeBrowser = function() {
  console.log('Removing', argv._[2], 'browser')
...
var printBrowsers = function(browsers) {
  for(var x = 0, y = browsers.length; x < y; x++) {
    ...
    if(browser.available) {
      console.log('Available'.green.bold, '-', browser.name.green, '\'ionic browser add', browser.name, '\'')
    } else {
      console.log('Not Available'.red.bold, '-', browser.name.green)
    }
  }
}
...
IonicTask.prototype.listBrowsers = function() {
  ...
  console.log('iOS - Browsers available:\n')

  printBrowsers(iosBrowsers);

  console.log('\n\nAndroid - Browsers available:\n')
