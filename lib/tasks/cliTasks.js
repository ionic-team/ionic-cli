...
var TASKS = [
  ...
  },
  {
    ...
    options: {
      ...
      '--keystore': 'For Android release builds, specify the location of your keystore file',
      '--keystore-password': 'For Android release builds, specify your keystore password (exclude for prompt)',
      '--key-alias': 'For Android release builds, specify your key alias for this app',
      '--key-password': 'For Android release builds, specify your key password for this app (exclude for prompt)',
      '--cert': 'For iOS builds, specify the location of your .p12 file',
      '--cert-password': 'For iOS builds, specify your certificate password (exclude for prompt)',
      '--provisioning-profile': 'For iOS builds, specify the location of your .mobileprovision file'
    },
