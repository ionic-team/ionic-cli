...
var TASKS = [
  ...
  },
  {
    ...
    args: {
      '<command>': 'build'.yellow + ', ' + 'list'.yellow + ', ' + 'info'.yellow + ', or ' + 'download'.yellow,
      '[options]': ''
    },
    options: {
      '--release': '(' + 'build'.yellow + ') Mark this build as a release',
      '--keystore|-s <path>': '(' + 'build android'.yellow + ') Specify the location of your keystore file',
      '--keystore-password|-p <password>': '(' + 'build android'.yellow + ') Specify your keystore password (exclude for prompt)',
      '--key-alias|-k <alias>': '(' + 'build android'.yellow + ') Specify your key alias for this app',
      '--key-password|-w <password>': '(' + 'build android'.yellow + ') Specify your key password for this app (exclude for prompt)',
      '--cert|-c <path>': '(' + 'build ios'.yellow + ') Specify the location of your .p12 file',
      '--cert-password|-p <password>': '(' + 'build ios'.yellow + ') Specify your certificate password (exclude for prompt)',
      '--provisioning-profile|-r <path>': '(' + 'build ios'.yellow + ') Specify the location of your .mobileprovision file'
    },
