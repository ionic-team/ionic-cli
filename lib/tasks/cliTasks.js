...
var TASKS = [
  ...
  },
  {
    title: 'package build',
    name: 'package',
    summary: 'Package up your app into .apk or .ipa files with Ionic Package ' + '(alpha)'.red,
    args: {
      '<platform>': 'android'.yellow + ' or ' + 'ios'.yellow,
      '[options]': ''
    },
    options: {
      '--release': 'Mark this build as a release',
      '--keystore <path>': 'For Android release builds, specify the location of your keystore file',
      '--keystore-password <password>': 'For Android release builds, specify your keystore password (exclude for prompt)',
      '--key-alias <alias>': 'For Android release builds, specify your key alias for this app',
      '--key-password <password>': 'For Android release builds, specify your key password for this app (exclude for prompt)',
      '--cert <path>': 'For iOS builds, specify the location of your .p12 file',
      '--cert-password <password>': 'For iOS builds, specify your certificate password (exclude for prompt)',
      '--provisioning-profile <path>': 'For iOS builds, specify the location of your .mobileprovision file'
    },
  ...
  },
  {
    title: 'package list',
    name: 'package',
    summary: 'List the latest builds of your app in Ionic Package ' + '(alpha)'.red,
    module: './ionic/package'
  },
  {
    title: 'package download',
    name: 'package',
    summary: 'Download a packaged build of your app (.apk/.ipa) from Ionic Package ' + '(alpha)'.red,
    args: {
      '<build-id>': 'The ID of the build to download'
    },
    module: './ionic/package'
  },
  {
