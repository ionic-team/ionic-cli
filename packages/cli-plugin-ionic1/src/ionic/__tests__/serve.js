...
describe('Serve', function() {
  ...
  describe('run command', function() {
    beforeEach(function() {
      spyOn(process, 'cwd').and.returnValue('/some/project/dir');
      spyOn(log, 'error');
    });
    ...
    it('should fail if loading the ionic project fails', function(done) {
      ...
      spyOn(IonicProject, 'load').and.callFake(function() {
        throw error;
      });
    ...
    it('should fail if loading the ionic project fails', function(done) {
      ...
      spyOn(npmScripts, 'hasIonicScript').and.returnValue(Q(false));
      spyOn(IonicProject, 'load').and.returnValue({
        get: function() {
          return false;
        }
      });
      process.env = {};
      spyOn(Serve, 'getAddress').and.callFake(function() {
        throw error;
      });
    ...
    it('should call appLibUtils when chain fails', function(done) {
      ...
      process.env = {};
      spyOn(Serve, 'getAddress').and.returnValue(Q());
      spyOn(Serve, 'checkPorts').and.returnValue(Q.reject(error));
    ...
    it('should use connect live reload port from env var', function(done) {
      ...
      spyOn(npmScripts, 'hasIonicScript').and.returnValue(Q(false));
      spyOn(IonicProject, 'load').and.returnValue({});
      spyOn(Serve, 'loadSettings').and.returnValue({});
      spyOn(Serve, 'getAddress').and.returnValue(Q());
