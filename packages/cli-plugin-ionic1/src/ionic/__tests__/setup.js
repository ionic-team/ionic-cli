...
describe('setup command', function() {
  ...
  describe('run function', function() {
    ...
    it('should succeed if sass was passed and sassSetup returns success', function(done) {
      ...
      spyOn(log, 'info');
      spyOn(log, 'error');
      spyOn(process, 'cwd').and.returnValue(dir);
      spyOn(appLibSetup, 'sassSetup').and.returnValue(Q(true));
    ...
    it('should fail if sass was passed and sassSetup returns an error', function(done) {
      ...
      spyOn(log, 'error');
      spyOn(process, 'cwd').and.returnValue(dir);
      spyOn(appLibSetup, 'sassSetup').and.returnValue(Q.reject('error occurred'));
