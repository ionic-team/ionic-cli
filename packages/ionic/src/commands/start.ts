...
import { BACKEND_LEGACY, BACKEND_PRO, CommandLineInputs, CommandLineOptions, CommandMetadata, CommandPreRun, OptionGroup, ResolvedStarterTemplate, StarterManifest, getProject } from '@ionic/cli-utils';
...
${chalk.cyan('[1]')}: ${chalk.bold('https://ionicframework.com/docs/cli/starters.html')}
  ...
  async run(inputs: CommandLineInputs, options: CommandLineOptions): Promise<void> {
    ...
    this.env.project = await getProject(projectDir, { log: this.env.log });
