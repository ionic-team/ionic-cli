...
export const PROJECT_TYPES: ProjectType[] = ['angular', ANGULAR_STANDALONE, 'react', 'vue', 'ionic-angular', 'custom', 'vue-vite', 'react-vite'];
export const LEGACY_PROJECT_TYPES: ProjectType[] = ['ionic-angular'];
